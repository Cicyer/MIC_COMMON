...
var file_ManagerService_proto_rawDesc = []byte{
	...
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0xce, 0x07, 0x0a, 0x0e, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x74,
	0x72, 0x61, 0x63, 0x74, 0x4d, 0x69, 0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x12, 0x58,
	0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x61, 0x73, 0x68, 0x48,
	...
	0x61, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x42, 0x27, 0x5a, 0x25, 0x73, 0x65, 0x72, 0x76, 0x69,
...
var file_ManagerService_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
...
var file_ManagerService_proto_depIdxs = []int32{
	31, // 0: ManagerService.CompanyHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	2,  // 1: ManagerService.GetCompanyHashResp.list:type_name -> ManagerService.CompanyHash
	31, // 2: ManagerService.MiHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	5,  // 3: ManagerService.GetMiHashResp.list:type_name -> ManagerService.MiHash
	31, // 4: ManagerService.MedicineHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	8,  // 5: ManagerService.GetMedicineResp.list:type_name -> ManagerService.MedicineHash
	31, // 6: ManagerService.ContractHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	11, // 7: ManagerService.GetContractHashResp.list:type_name -> ManagerService.ContractHash
	31, // 8: ManagerService.ContractMiHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	14, // 9: ManagerService.GetContractMiHashResp.list:type_name -> ManagerService.ContractMiHash
	31, // 10: ManagerService.ConfigHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	17, // 11: ManagerService.GetConfigHashResp.list:type_name -> ManagerService.ConfigHash
	31, // 12: ManagerService.ShipmentPlanHash.infoUploadAt:type_name -> google.protobuf.Timestamp
	31, // 13: ManagerService.ShipmentPlanHash.qrCodeUploadAt:type_name -> google.protobuf.Timestamp
	31, // 14: ManagerService.ShipmentPlanHash.shipmentStartUploadAt:type_name -> google.protobuf.Timestamp
	31, // 15: ManagerService.ShipmentPlanHash.shipmentReceiveUploadAt:type_name -> google.protobuf.Timestamp
	31, // 16: ManagerService.ShipmentPlanHash.shipmentEnterUploadAt:type_name -> google.protobuf.Timestamp
	20, // 17: ManagerService.GetShipmentPlanHashResp.list:type_name -> ManagerService.ShipmentPlanHash
	31, // 18: ManagerService.ShipmentOrderHash.qrCodeUploadAt:type_name -> google.protobuf.Timestamp
	31, // 19: ManagerService.ShipmentOrderHash.shipmentStartUploadAt:type_name -> google.protobuf.Timestamp
	31, // 20: ManagerService.ShipmentOrderHash.shipmentReceiveUploadAt:type_name -> google.protobuf.Timestamp
	31, // 21: ManagerService.ShipmentOrderHash.shipmentEnterUploadAt:type_name -> google.protobuf.Timestamp
	23, // 22: ManagerService.GetShipmentOrderHashResp.list:type_name -> ManagerService.ShipmentOrderHash
	31, // 23: ManagerService.ShipmentPayHash.qrCodeUploadAt:type_name -> google.protobuf.Timestamp
	31, // 24: ManagerService.ShipmentPayHash.shipmentStartUploadAt:type_name -> google.protobuf.Timestamp
	31, // 25: ManagerService.ShipmentPayHash.shipmentReceiveUploadAt:type_name -> google.protobuf.Timestamp
	31, // 26: ManagerService.ShipmentPayHash.shipmentEnterUploadAt:type_name -> google.protobuf.Timestamp
	26, // 27: ManagerService.GetShipmentPayHashResp.list:type_name -> ManagerService.ShipmentPayHash
	31, // 28: ManagerService.ShipmentFactoringHash.applyUploadAt:type_name -> google.protobuf.Timestamp
	31, // 29: ManagerService.ShipmentFactoringHash.resultUploadAt:type_name -> google.protobuf.Timestamp
	31, // 30: ManagerService.ShipmentFactoringHash.payBackUploadAt:type_name -> google.protobuf.Timestamp
	29, // 31: ManagerService.GetShipmentFactoringHashResp.list:type_name -> ManagerService.ShipmentFactoringHash
	1,  // 32: ManagerService.ManagerService.GetCompanyHash:input_type -> ManagerService.GetCompanyHashReq
	4,  // 33: ManagerService.ManagerService.GetMiHash:input_type -> ManagerService.GetMiHashReq
	7,  // 34: ManagerService.ManagerService.GetMedicineHash:input_type -> ManagerService.GetMedicineReq
	10, // 35: ManagerService.ManagerService.GetContractHash:input_type -> ManagerService.GetContractHashReq
	13, // 36: ManagerService.ManagerService.GetContractMiHash:input_type -> ManagerService.GetContractMiHashReq
	16, // 37: ManagerService.ManagerService.GetConfigHashHash:input_type -> ManagerService.GetConfigHashReq
	19, // 38: ManagerService.ManagerService.GetShipmentPlanHash:input_type -> ManagerService.GetShipmentPlanHashReq
	22, // 39: ManagerService.ManagerService.GetShipmentOrderHash:input_type -> ManagerService.GetShipmentOrderHashReq
	25, // 40: ManagerService.ManagerService.GetShipmentPayHash:input_type -> ManagerService.GetShipmentPayHashReq
	28, // 41: ManagerService.ManagerService.GetShipmentFactoringHash:input_type -> ManagerService.GetShipmentFactoringHashReq
	3,  // 42: ManagerService.ManagerService.GetCompanyHash:output_type -> ManagerService.GetCompanyHashResp
	6,  // 43: ManagerService.ManagerService.GetMiHash:output_type -> ManagerService.GetMiHashResp
	9,  // 44: ManagerService.ManagerService.GetMedicineHash:output_type -> ManagerService.GetMedicineResp
	12, // 45: ManagerService.ManagerService.GetContractHash:output_type -> ManagerService.GetContractHashResp
	15, // 46: ManagerService.ManagerService.GetContractMiHash:output_type -> ManagerService.GetContractMiHashResp
	18, // 47: ManagerService.ManagerService.GetConfigHashHash:output_type -> ManagerService.GetConfigHashResp
	21, // 48: ManagerService.ManagerService.GetShipmentPlanHash:output_type -> ManagerService.GetShipmentPlanHashResp
	24, // 49: ManagerService.ManagerService.GetShipmentOrderHash:output_type -> ManagerService.GetShipmentOrderHashResp
	27, // 50: ManagerService.ManagerService.GetShipmentPayHash:output_type -> ManagerService.GetShipmentPayHashResp
	30, // 51: ManagerService.ManagerService.GetShipmentFactoringHash:output_type -> ManagerService.GetShipmentFactoringHashResp
