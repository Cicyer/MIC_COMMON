...
var file_ManagerService_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xda, 0x01, 0x0a, 0x0c, 0x47,
	...
	0x74, 0x79, 0x70, 0x65, 0x54, 0x68, 0x72, 0x65, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xdc, 0x02, 0x0a, 0x0c, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x64, 0x61, 0x74, 0x65, 0x4d, 0x69, 0x53, 0x70, 0x65, 0x63, 0x69, 0x61, 0x6c, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x32, 0xba, 0x28, 0x0a, 0x0e, 0x4d, 0x61, 0x6e, 0x61,
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x57, 0x0a, 0x0e, 0x43, 0x6f, 0x6e,
	...
	0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x42, 0x0a, 0x07, 0x54, 0x61, 0x67, 0x4c, 0x69, 0x73,
	...
	0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x54, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x70, 0x50,
...
var file_ManagerService_proto_depIdxs = []int32{
	...
	140, // 80: ManagerService.CommonConfig.startAt:type_name -> google.protobuf.Timestamp
	140, // 81: ManagerService.CommonConfig.endAt:type_name -> google.protobuf.Timestamp
	140, // 82: ManagerService.CommonConfig.created:type_name -> google.protobuf.Timestamp
	129, // 83: ManagerService.GetConfigResp.list:type_name -> ManagerService.CommonConfig
	141, // 84: ManagerService.GetHashContentResp.data:type_name -> google.protobuf.Any
	140, // 85: ManagerService.GetHashContentResp.uploadSuccessAt:type_name -> google.protobuf.Timestamp
	0,   // 86: ManagerService.GetMiSpecialConfigReq.page:type_name -> ManagerService.Page
	136, // 87: ManagerService.GetMiSpecialConfigResp.list:type_name -> ManagerService.MiSpecialConfig
	...
	67,  // 115: ManagerService.ManagerService.ListCompany:input_type -> ManagerService.ListCompanyReq
	70,  // 116: ManagerService.ManagerService.CreateOneCompany:input_type -> ManagerService.CreateOneCompanyReq
	72,  // 117: ManagerService.ManagerService.UpdateOneCompany:input_type -> ManagerService.UpdateOneCompanyReq
	64,  // 118: ManagerService.ManagerService.CommonCompany:input_type -> ManagerService.CommonCompanyReq
	74,  // 119: ManagerService.ManagerService.ListTpPlanErr:input_type -> ManagerService.ListTpPlanErrReq
	77,  // 120: ManagerService.ManagerService.UpdateErrShipmentPlan:input_type -> ManagerService.UpdateErrShipmentPlanReq
	79,  // 121: ManagerService.ManagerService.ListShipmentPlan:input_type -> ManagerService.ListShipmentPlanReq
	87,  // 122: ManagerService.ManagerService.CountShipmentPlan:input_type -> ManagerService.CountShipmentPlanReq
	82,  // 123: ManagerService.ManagerService.DetailShipmentOrder:input_type -> ManagerService.DetailShipmentOrderReq
	84,  // 124: ManagerService.ManagerService.ListShipmentPlanForOrder:input_type -> ManagerService.ListShipmentPlanForOrderReq
	89,  // 125: ManagerService.ManagerService.CreateShipmentOrder:input_type -> ManagerService.CreateShipmentOrderReq
	91,  // 126: ManagerService.ManagerService.ListShipmentOrder:input_type -> ManagerService.ListShipmentOrderReq
	94,  // 127: ManagerService.ManagerService.UpdateShipmentOrder:input_type -> ManagerService.UpdateShipmentOrderReq
	96,  // 128: ManagerService.ManagerService.GetCompanyHash:input_type -> ManagerService.GetCompanyHashReq
	99,  // 129: ManagerService.ManagerService.GetMiHash:input_type -> ManagerService.GetMiHashReq
	102, // 130: ManagerService.ManagerService.GetMedicineHash:input_type -> ManagerService.GetMedicineReq
	105, // 131: ManagerService.ManagerService.GetContractHash:input_type -> ManagerService.GetContractHashReq
	108, // 132: ManagerService.ManagerService.GetContractMiHash:input_type -> ManagerService.GetContractMiHashReq
	111, // 133: ManagerService.ManagerService.GetConfigHash:input_type -> ManagerService.GetConfigHashReq
	114, // 134: ManagerService.ManagerService.GetShipmentPlanHash:input_type -> ManagerService.GetShipmentPlanHashReq
	117, // 135: ManagerService.ManagerService.GetShipmentOrderHash:input_type -> ManagerService.GetShipmentOrderHashReq
	120, // 136: ManagerService.ManagerService.GetShipmentPayHash:input_type -> ManagerService.GetShipmentPayHashReq
	123, // 137: ManagerService.ManagerService.GetShipmentFactoringHash:input_type -> ManagerService.GetShipmentFactoringHashReq
	133, // 138: ManagerService.ManagerService.GetHashContent:input_type -> ManagerService.GetHashContentReq
	128, // 139: ManagerService.ManagerService.GetConfig:input_type -> ManagerService.GetConfigReq
	127, // 140: ManagerService.ManagerService.UpdateConfig:input_type -> ManagerService.UpdateConfigReq
	126, // 141: ManagerService.ManagerService.InsertConfigs:input_type -> ManagerService.InsertConfigsReq
	135, // 142: ManagerService.ManagerService.GetMiSpecialConfig:input_type -> ManagerService.GetMiSpecialConfigReq
	138, // 143: ManagerService.ManagerService.UpdateMiSpecialConfig:input_type -> ManagerService.UpdateMiSpecialConfigReq
	7,   // 144: ManagerService.ManagerService.ListContract:output_type -> ManagerService.ContractListResp
	10,  // 145: ManagerService.ManagerService.ListMiContract:output_type -> ManagerService.ContractMiListResp
	13,  // 146: ManagerService.ManagerService.CreateOneContractMI:output_type -> ManagerService.CreateOneContractMIResp
	15,  // 147: ManagerService.ManagerService.UpdateOneContractMI:output_type -> ManagerService.UpdateOneContractMIResp
	17,  // 148: ManagerService.ManagerService.UpdateOneContract:output_type -> ManagerService.UpdateOneContractResp
	19,  // 149: ManagerService.ManagerService.UpdateContractActive:output_type -> ManagerService.UpdateContractActiveResp
	21,  // 150: ManagerService.ManagerService.DeleteOneContract:output_type -> ManagerService.DeleteOneContractResp
	23,  // 151: ManagerService.ManagerService.DeleteOneContractMi:output_type -> ManagerService.DeleteOneContractMiResp
	2,   // 152: ManagerService.ManagerService.GetContractInfo:output_type -> ManagerService.GetContractInfoResp
	4,   // 153: ManagerService.ManagerService.ContractDetail:output_type -> ManagerService.ContractDetailResp
	25,  // 154: ManagerService.ManagerService.ListMedicine:output_type -> ManagerService.MedicineListResp
	28,  // 155: ManagerService.ManagerService.MedicineListForQuery:output_type -> ManagerService.MedicineListForQueryResp
	31,  // 156: ManagerService.ManagerService.CreateMedicine:output_type -> ManagerService.CreateMedicineResp
	33,  // 157: ManagerService.ManagerService.UpdateMedicine:output_type -> ManagerService.UpdateMedicineResp
	35,  // 158: ManagerService.ManagerService.UpdateMedicineActive:output_type -> ManagerService.UpdateMedicineActiveResp
	37,  // 159: ManagerService.ManagerService.DeleteMedicine:output_type -> ManagerService.DeleteMedicineResp
	39,  // 160: ManagerService.ManagerService.TagList:output_type -> ManagerService.TagListResp
	42,  // 161: ManagerService.ManagerService.CreateTag:output_type -> ManagerService.CreateTagResp
	44,  // 162: ManagerService.ManagerService.UpdateTag:output_type -> ManagerService.UpdateTagResp
	46,  // 163: ManagerService.ManagerService.DeleteTag:output_type -> ManagerService.DeleteTagResp
	48,  // 164: ManagerService.ManagerService.TagDetailList:output_type -> ManagerService.TagDetailListResp
	51,  // 165: ManagerService.ManagerService.DeleteTagMedicine:output_type -> ManagerService.DeleteTagMedicineResp
	53,  // 166: ManagerService.ManagerService.CreateTagMedicine:output_type -> ManagerService.CreateTagMedicineResp
	55,  // 167: ManagerService.ManagerService.ListMi:output_type -> ManagerService.ListMiResp
	58,  // 168: ManagerService.ManagerService.CommonMI:output_type -> ManagerService.CommonMIResp
	61,  // 169: ManagerService.ManagerService.CreateOneMI:output_type -> ManagerService.CreateOneMIResp
	63,  // 170: ManagerService.ManagerService.UpdateMi:output_type -> ManagerService.UpdateMiResp
	68,  // 171: ManagerService.ManagerService.ListCompany:output_type -> ManagerService.ListCompanyResp
	71,  // 172: ManagerService.ManagerService.CreateOneCompany:output_type -> ManagerService.CreateOneCompanyResp
	73,  // 173: ManagerService.ManagerService.UpdateOneCompany:output_type -> ManagerService.UpdateOneCompanyResp
	65,  // 174: ManagerService.ManagerService.CommonCompany:output_type -> ManagerService.CommonCompanyResp
	75,  // 175: ManagerService.ManagerService.ListTpPlanErr:output_type -> ManagerService.ListTpPlanErrResp
	78,  // 176: ManagerService.ManagerService.UpdateErrShipmentPlan:output_type -> ManagerService.UpdateErrShipmentPlanResp
	80,  // 177: ManagerService.ManagerService.ListShipmentPlan:output_type -> ManagerService.ListShipmentPlanResp
	88,  // 178: ManagerService.ManagerService.CountShipmentPlan:output_type -> ManagerService.CountShipmentPlanResp
	83,  // 179: ManagerService.ManagerService.DetailShipmentOrder:output_type -> ManagerService.DetailShipmentOrderResp
	85,  // 180: ManagerService.ManagerService.ListShipmentPlanForOrder:output_type -> ManagerService.ListShipmentPlanForOrderResp
	90,  // 181: ManagerService.ManagerService.CreateShipmentOrder:output_type -> ManagerService.CreateShipmentOrderResp
	92,  // 182: ManagerService.ManagerService.ListShipmentOrder:output_type -> ManagerService.ListShipmentOrderResp
	95,  // 183: ManagerService.ManagerService.UpdateShipmentOrder:output_type -> ManagerService.UpdateShipmentOrderResp
	98,  // 184: ManagerService.ManagerService.GetCompanyHash:output_type -> ManagerService.GetCompanyHashResp
	101, // 185: ManagerService.ManagerService.GetMiHash:output_type -> ManagerService.GetMiHashResp
	104, // 186: ManagerService.ManagerService.GetMedicineHash:output_type -> ManagerService.GetMedicineResp
	107, // 187: ManagerService.ManagerService.GetContractHash:output_type -> ManagerService.GetContractHashResp
	110, // 188: ManagerService.ManagerService.GetContractMiHash:output_type -> ManagerService.GetContractMiHashResp
	113, // 189: ManagerService.ManagerService.GetConfigHash:output_type -> ManagerService.GetConfigHashResp
	116, // 190: ManagerService.ManagerService.GetShipmentPlanHash:output_type -> ManagerService.GetShipmentPlanHashResp
	119, // 191: ManagerService.ManagerService.GetShipmentOrderHash:output_type -> ManagerService.GetShipmentOrderHashResp
	122, // 192: ManagerService.ManagerService.GetShipmentPayHash:output_type -> ManagerService.GetShipmentPayHashResp
	125, // 193: ManagerService.ManagerService.GetShipmentFactoringHash:output_type -> ManagerService.GetShipmentFactoringHashResp
	134, // 194: ManagerService.ManagerService.GetHashContent:output_type -> ManagerService.GetHashContentResp
	132, // 195: ManagerService.ManagerService.GetConfig:output_type -> ManagerService.GetConfigResp
	130, // 196: ManagerService.ManagerService.UpdateConfig:output_type -> ManagerService.UpdateConfigResp
	131, // 197: ManagerService.ManagerService.InsertConfigs:output_type -> ManagerService.InsertConfigsResp
	137, // 198: ManagerService.ManagerService.GetMiSpecialConfig:output_type -> ManagerService.GetMiSpecialConfigResp
	139, // 199: ManagerService.ManagerService.UpdateMiSpecialConfig:output_type -> ManagerService.UpdateMiSpecialConfigResp
	144, // [144:200] is the sub-list for method output_type
	88,  // [88:144] is the sub-list for method input_type
