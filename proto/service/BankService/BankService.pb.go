...
var file_BankService_proto_rawDesc = []byte{
	...
	0x73, 0x67, 0x22, 0x55, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61,
	...
	0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x52, 0x65, 0x73, 0x70, 0x32, 0xdc, 0x03, 0x0a, 0x17, 0x53,
	...
	0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x32, 0xf5, 0x03, 0x0a, 0x15, 0x46, 0x61,
...
var file_BankService_proto_depIdxs = []int32{
	...
	50, // 45: BankService.FactoringOrderPlan.invoiceDate:type_name -> google.protobuf.Timestamp
	50, // 46: BankService.FactoringOrderPlan.receiveAt:type_name -> google.protobuf.Timestamp
	50, // 47: BankService.FactoringOrderPlan.applyAt:type_name -> google.protobuf.Timestamp
	50, // 48: BankService.FactoringOrderPlan.applyResultAt:type_name -> google.protobuf.Timestamp
	37, // 49: BankService.ListFactoringOrderPlanResp.list:type_name -> BankService.FactoringOrderPlan
	0,  // 50: BankService.ListFactoringPayOrderReq.page:type_name -> BankService.Page
	50, // 51: BankService.ListFactoringPayOrderReq.payDeadlineStartAt:type_name -> google.protobuf.Timestamp
	50, // 52: BankService.ListFactoringPayOrderReq.payDeadlineEndAt:type_name -> google.protobuf.Timestamp
	50, // 53: BankService.ListFactoringPayOrderReq.receiveStartAt:type_name -> google.protobuf.Timestamp
	50, // 54: BankService.ListFactoringPayOrderReq.receiveEndAt:type_name -> google.protobuf.Timestamp
	50, // 55: BankService.FactoringPayOrder.payAt:type_name -> google.protobuf.Timestamp
	50, // 56: BankService.FactoringPayOrder.receiveAt:type_name -> google.protobuf.Timestamp
	50, // 57: BankService.FactoringPayOrder.payDeadline:type_name -> google.protobuf.Timestamp
	50, // 58: BankService.FactoringPayOrder.factoringDeadline:type_name -> google.protobuf.Timestamp
	50, // 59: BankService.FactoringPayOrder.applyAt:type_name -> google.protobuf.Timestamp
	50, // 60: BankService.FactoringPayOrder.applyResultAt:type_name -> google.protobuf.Timestamp
	50, // 61: BankService.FactoringPayOrder.refundAt:type_name -> google.protobuf.Timestamp
	46, // 62: BankService.ListFactoringPayOrderResp.list:type_name -> BankService.FactoringPayOrder
	1,  // 63: BankService.BankService.ListBankAccount:input_type -> BankService.ListBankAccountReq
	4,  // 64: BankService.BankService.CreateOneAccountInfo:input_type -> BankService.CreateOneAccountInfoReq
	9,  // 65: BankService.BankService.UpdateBankAccount:input_type -> BankService.UpdateBankAccountReq
	7,  // 66: BankService.BankService.UpdateBankAccountList:input_type -> BankService.UpdateBankAccountListReq
	11, // 67: BankService.BankService.GetCompanyCreditConfigs:input_type -> BankService.GetCompanyCreditConfigsReq
	14, // 68: BankService.BankService.UpdateCompanyCreditConfig:input_type -> BankService.UpdateCompanyCreditConfigReq
	16, // 69: BankService.BankService.GetCompanyBankAccountDetail:input_type -> BankService.GetCompanyBankAccountDetailReq
	18, // 70: BankService.BankService.CompanyWithdraw:input_type -> BankService.CompanyWithdrawReq
	43, // 71: BankService.BankService.GetWithdrawReceipt:input_type -> BankService.GetWithdrawReceiptReq
	20, // 72: BankService.BankService.ListCompanyWithdraw:input_type -> BankService.ListCompanyWithdrawReq
	23, // 73: BankService.ShipmentPayOrderService.ListPayOrder:input_type -> BankService.ListPayOrderReq
	26, // 74: BankService.ShipmentPayOrderService.ListPayOrderPlan:input_type -> BankService.ListPayOrderPlanReq
	29, // 75: BankService.ShipmentPayOrderService.FinishPayOrderError:input_type -> BankService.FinishPayOrderErrorReq
	34, // 76: BankService.ShipmentPayOrderService.GetTransferReceipt:input_type -> BankService.GetTransferReceiptReq
	41, // 77: BankService.ShipmentPayOrderService.PayShipmentOrders:input_type -> BankService.PayShipmentOrdersReq
	31, // 78: BankService.FactoringOrderService.ListFactoringOrder:input_type -> BankService.ListFactoringOrderReq
	45, // 79: BankService.FactoringOrderService.ListFactoringPayOrder:input_type -> BankService.ListFactoringPayOrderReq
	36, // 80: BankService.FactoringOrderService.ListFactoringOrderPlan:input_type -> BankService.ListFactoringOrderPlanReq
	39, // 81: BankService.FactoringOrderService.FinishFactoringOrderError:input_type -> BankService.FinishFactoringOrderErrorReq
	48, // 82: BankService.FactoringOrderService.Apply:input_type -> BankService.ApplyReq
	2,  // 83: BankService.BankService.ListBankAccount:output_type -> BankService.ListBankAccountResp
	6,  // 84: BankService.BankService.CreateOneAccountInfo:output_type -> BankService.CreateOneAccountInfoResp
	10, // 85: BankService.BankService.UpdateBankAccount:output_type -> BankService.UpdateBankAccountResp
	8,  // 86: BankService.BankService.UpdateBankAccountList:output_type -> BankService.UpdateBankAccountListResp
	13, // 87: BankService.BankService.GetCompanyCreditConfigs:output_type -> BankService.GetCompanyCreditConfigsResp
	15, // 88: BankService.BankService.UpdateCompanyCreditConfig:output_type -> BankService.UpdateCompanyCreditConfigResp
	17, // 89: BankService.BankService.GetCompanyBankAccountDetail:output_type -> BankService.GetCompanyBankAccountDetailResp
	19, // 90: BankService.BankService.CompanyWithdraw:output_type -> BankService.CompanyWithdrawResp
	44, // 91: BankService.BankService.GetWithdrawReceipt:output_type -> BankService.GetWithdrawReceiptResp
	22, // 92: BankService.BankService.ListCompanyWithdraw:output_type -> BankService.ListCompanyWithdrawResp
	25, // 93: BankService.ShipmentPayOrderService.ListPayOrder:output_type -> BankService.ListPayOrderResp
	28, // 94: BankService.ShipmentPayOrderService.ListPayOrderPlan:output_type -> BankService.ListPayOrderPlanResp
	30, // 95: BankService.ShipmentPayOrderService.FinishPayOrderError:output_type -> BankService.FinishPayOrderErrorResp
	35, // 96: BankService.ShipmentPayOrderService.GetTransferReceipt:output_type -> BankService.GetTransferReceiptResp
	42, // 97: BankService.ShipmentPayOrderService.PayShipmentOrders:output_type -> BankService.PayShipmentOrdersResp
	33, // 98: BankService.FactoringOrderService.ListFactoringOrder:output_type -> BankService.ListFactoringOrderResp
	47, // 99: BankService.FactoringOrderService.ListFactoringPayOrder:output_type -> BankService.ListFactoringPayOrderResp
	38, // 100: BankService.FactoringOrderService.ListFactoringOrderPlan:output_type -> BankService.ListFactoringOrderPlanResp
	40, // 101: BankService.FactoringOrderService.FinishFactoringOrderError:output_type -> BankService.FinishFactoringOrderErrorResp
	49, // 102: BankService.FactoringOrderService.Apply:output_type -> BankService.ApplyResp
